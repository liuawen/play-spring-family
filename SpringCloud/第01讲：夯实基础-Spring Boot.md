...
并于2014年4月发布第一个版本 其设计目的是用来简化Spring应用的搭建 以及开发过程

设计目的 用来简化Spring应用的搭建  开发过程

众所周知   Spring Boot 是由 Pivotal团队提供的全新框架
...
SpringBoot 简单的步骤 可以创建一个Spring应用

SB为Spring整合第三方框架提供了开箱即用功能
...
本地调试  线上部署  首先安装Tomcat   war包   项目编译成war包 部署到Tomcat中  这样非常不方便

应用监控做的比较简单  都是通过一个没有任何逻辑的接口来判断应用的存活状态
...
​    ![img](assets/CgoB5l16CcGASwhHAACb19MWf5Y813.png)
...
![img](assets/CgoB5l16F5CANbFZAMhzV5onKV0396.gif)
...
![img](assets/CgoB5l16F7yAfj3KAINssw4qZtI832.gif)
...
![img](assets/CgotOV16F8KAMXJ_AGVdCQqkM-0530.gif)

第三步，需要编写 RestController，开发业务接口，这里简单以 hello 接口为例，然后返回一个字符串。

 

![img](assets/CgoB5l16F-iASQEGAQ-_KSlfEgg265.gif)
...
Cannot resolve com.example:springboot-starter-demo:0.0.1-SNAPSHOT
...
![img](assets/CgoB5l16IDyAJGK5ADq0_nQL4t8907.gif)
...
![img](assets/CgotOV16GBaAGEOiAH_Dc2S7jJ0705.gif)
...
![img](assets/CgoB5l16GBeAVp78AIMD4WizaMw065.gif)

然后再创建一个 application-test.properties，配置 server.port=8083，现在相当于有 dev 和 test 两个环境的配置。



![img](assets/CgoB5l16HdGAEcguADyOblBXdxk142.gif)
...
![img](assets/CgotOV16GGiADV0UANCdt_kBzKo893.gif)
...
![img](assets/CgoB5l16GHiAP27rAMoepDQ1FXI596.gif)
...
![img](assets/CgoB5l16HeyABtn8AE5Ic7f5ZlA175.gif)
...
![img](assets/CgotOV16GIaAIfPXACGjQ0529lk579.gif)
...
![img](assets/CgotOV16HfaAI3bcAGA3upBSYqM629.gif)
...
![img](assets/CgotOV16JqeAV7NkAClhxNljPA4771.gif)
...
![img](assets/CgoB5l16Hp-AZy8aAGR-zCc9Gc8937.gif)
...
![img](assets/CgoB5l16HtiAEZE3AC6E2sTHc-4083.gif)
...
![img](assets/CgotOV16HvWAUv8UAFBYdAsnN2Y247.gif)

最后一步，我们需要在使用的项目中加入我们自定义的 Starter 的依赖，然后在配置文件中增加配置 spring.user.name，这样就完成了整个流程。



![img](assets/CgoB5l16HwWAURJJAEi-bnY39_0581.gif)
...
![img](assets/CgotOV16HweAcDlpAF9VpJeeMRQ119.gif)
